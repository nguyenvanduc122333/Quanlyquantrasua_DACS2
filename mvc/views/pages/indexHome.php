<section class="banner">
    <div class="box_slide_carousel">
        <div class="homi_slide owl-carousel owl-theme">
            <div class="item">
                <img alt="" src="public/images/n.jpg" class="responsive" draggable="false" style="height:600px;">
            </div>
            <div class="item">
                <img alt="" src="public/images/9.jpg" class="responsive" draggable="false" style="height:600px;" >
            </div>
            <div class="item">
                <img alt="" src="public/images/h.jpg" class="responsive" draggable="false" style="height:600px;">
            </div>
        </div>
    </div>
</section>
                    ...
                    <div class="select-content">
                        ...
                        <div class="box-setup">
                            <select id="tocotoddress" style="display: none;">
                                <option value="0" disabled="" selected="">Chọn cửa hàng TOCOTOCO</option>
                            ...
                            <div class="nice-select" tabindex="0"><span class="current">Chọn cửa hàng TOCOTOCO TEA</span>
                                <ul class="list">
                                    <li data-value="0" class="option selected disabled">Chọn cửa TOCOTOCO TEA</li>
